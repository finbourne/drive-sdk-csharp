...
namespace Lusid.Drive.Sdk.Api
{
    ...
    public interface IApplicationMetadataApiSync : IApiAccessor
    {
        ...
        Lusid.Drive.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> ListAccessControlledResourcesWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IApplicationMetadataApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Lusid.Drive.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource>> ListAccessControlledResourcesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        {
            Lusid.Drive.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> localVarResponse = ListAccessControlledResourcesWithHttpInfo(opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ResourceListOfAccessControlledResource</returns>
        public Lusid.Drive.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> ListAccessControlledResourcesWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null)
        {
        ...
        {
            Lusid.Drive.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> localVarResponse = await ListAccessControlledResourcesWithHttpInfoAsync(operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
