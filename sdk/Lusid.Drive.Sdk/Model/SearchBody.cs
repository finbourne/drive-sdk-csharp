...
namespace Lusid.Drive.Sdk.Model
{
    ...
    public partial class SearchBody : IEquatable<SearchBody>, IValidatableObject
    {
        ...
        {
            // WithPath (string) maxLength
            if (this.WithPath != null && this.WithPath.Length > 512)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for WithPath, length must be less than 512.", new [] { "WithPath" });
            }

            // WithPath (string) minLength
            if (this.WithPath != null && this.WithPath.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for WithPath, length must be greater than 1.", new [] { "WithPath" });
            }
