...
namespace Finbourne.Drive.Sdk.Model
{
    ...
    public partial class StorageObject : IEquatable<StorageObject>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // UpdatedBy (string) minLength
            if (this.UpdatedBy != null && this.UpdatedBy.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UpdatedBy, length must be greater than 1.", new [] { "UpdatedBy" });
            }
