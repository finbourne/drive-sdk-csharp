...
namespace Finbourne.Drive.Sdk.Extensions
{
    /// <summary>
    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { "BaseUrl", "FBN_FINBOURNE-DRIVE_API_URL" },
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-DRIVE_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-drive_api_url"),
